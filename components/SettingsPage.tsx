...
const AvatarUploader: React.FC<{
  ...
  return (
    <div className="flex items-center gap-4">
      <div className="relative h-16 w-16 overflow-hidden rounded-full border border-[var(--border)] bg-[var(--card)]">
        {objectUrl ? (
      ...
      <div className="flex-1">
        <div
          className="flex items-center justify-between gap-3 rounded-lg border border-dashed border-[var(--border)] bg-[var(--card)] p-3"
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              onClick={openPicker}
              className="rounded-md border border-[var(--border)] bg-[var(--card)] px-3 py-2 text-[var(--text)] hover:bg-[var(--bg)]"
            >
              Upload
            </button>
            ...
            {objectUrl ? (
              <button
                onClick={onRemove}
                className="rounded-md border border-[var(--border)] bg-rose-600/10 px-3 py-2 text-rose-300 hover:bg-rose-600/20"
              >
                Remove
              </button>
            ) : null}
        ...
        <p className="mt-2 text-xs text-[var(--subtle)]">PNG, JPG, WEBP, GIF, SVG. Max 3MB.</p>
      </div>
    </div>
  );
};
  ...
  return (
    <div className="space-y-8">
      ...
      <Section title="User Profile" desc="Your public identity in Zenith">
        <AvatarUploader objectUrl={avatarObjectUrl} setObjectUrl={setAvatarFilePreview} />
        <div>
        ...
        <div className="flex items-center justify-between rounded-lg border border-rose-700 bg-rose-900/20 p-4">
          ...
          <button
            ...
            className={`rounded-lg px-4 py-2 ${
              confirmClear ? "bg-rose-700 text-white" : "bg-rose-600 text-white hover:bg-rose-700"
            }`}
